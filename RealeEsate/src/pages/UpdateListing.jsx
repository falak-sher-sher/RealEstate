...
useEffect(()=>{
    ...
    const listingId = params.id; // FIXED: Changed from params.listingId to params.id to match route definition
  ...
  // FIXED: Submit form to update listing in MongoDB
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // FIXED: Use update endpoint with listing ID from params
      const listingId = params.id; // FIXED: Changed from params.listingId to params.id to match route definition
      console.log('Updating listing with ID:', listingId);
      
      const res = await fetch(`/Backend/listing/update/${listingId}`, {
        method: 'POST',
        headers: {
